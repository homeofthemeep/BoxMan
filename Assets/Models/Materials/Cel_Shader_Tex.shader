...
Shader "Our Toonshader Vol. 4" {
	Properties{
		...
		_BumpMap("Normal Texture", 2D) = "nothing" {}
...
#pragma fragment frag
	...
	float specularCutoff = saturate(max(_Shininess, dot(reflect(-input.lightDir.xyz, input.normalDir) * 1000, input.viewDir)) - _Shininess * 1000);
