...
public class GCTracker : DeviceTracker {
    ...
    {
        //reader.Read(e, 10, out transferLength);

        reader.SubmitAsyncTransfer(e, 0, e.Length, 10, out usbReaderTransfer);

        //WaitHandle.WaitAll(new WaitHandle[] { usbReaderTransfer.AsyncWaitHandle }, 5, false);
